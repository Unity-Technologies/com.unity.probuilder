...
namespace UnityEditor.ProBuilder
{
    ...
    sealed class ProBuilderMeshEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUI.showMixedValue = targets.Length > 1;
            EditorGUILayout.TextField("ProBuilderMesh", m_Mesh.GetInstanceID().ToString());
            EditorGUILayout.TextField("UnityEngine.Mesh", sharedMesh != null ? sharedMesh.GetInstanceID().ToString(): "-1");
