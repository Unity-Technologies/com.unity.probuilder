...
namespace UnityEditor.ProBuilder
{
	...
	public static class MenuActionStyles
	{
		...
		static GUIStyle m_ButtonStyleVertical = null;
		...
		public static GUIStyle buttonStyleVertical
		{
			get
			{
				if(m_ButtonStyleVertical == null)
				{
					...
					m_ButtonStyleVertical.normal.background = IconUtility.GetIcon("Toolbar/Button_Normal", IconSkin.Pro);
					m_ButtonStyleVertical.normal.textColor = EditorGUIUtility.isProSkin ? TEXT_COLOR_WHITE_NORMAL : Color.black;
					m_ButtonStyleVertical.hover.background = IconUtility.GetIcon("Toolbar/Button_Hover", IconSkin.Pro);
		...
		static GUIStyle m_ButtonStyleHorizontal = null;
		...
		public static GUIStyle buttonStyleHorizontal
		{
			get
			{
				if(m_ButtonStyleHorizontal == null)
				{
					...
					m_ButtonStyleHorizontal.normal.background 	= IconUtility.GetIcon("Toolbar/Button_Normal_Horizontal", IconSkin.Pro);
					m_ButtonStyleHorizontal.hover.background 	= IconUtility.GetIcon("Toolbar/Button_Hover_Horizontal", IconSkin.Pro);
					m_ButtonStyleHorizontal.hover.textColor 		= EditorGUIUtility.isProSkin ? TEXT_COLOR_WHITE_HOVER : Color.black;
					m_ButtonStyleHorizontal.active.background 	= IconUtility.GetIcon("Toolbar/Button_Pressed_Horizontal", IconSkin.Pro);
		...
		static GUIStyle m_RowStyleVertical = null;
		...
		static GUIStyle m_RowStyleHorizontal = null;
		...
		static GUIStyle m_AltButtonStyle = null;
		...
		public static GUIStyle altButtonStyle
		{
			get
			{
				if(m_AltButtonStyle == null)
				{
					...
					m_AltButtonStyle.normal.background 	= IconUtility.GetIcon("Toolbar/AltButton_Normal", IconSkin.Pro);
					m_AltButtonStyle.normal.textColor 	= EditorGUIUtility.isProSkin ? TEXT_COLOR_WHITE_NORMAL : Color.black;
					m_AltButtonStyle.hover.background 	= IconUtility.GetIcon("Toolbar/AltButton_Hover", IconSkin.Pro);
					m_AltButtonStyle.hover.textColor 	= EditorGUIUtility.isProSkin ? TEXT_COLOR_WHITE_HOVER : Color.black;
					m_AltButtonStyle.active.background 	= IconUtility.GetIcon("Toolbar/AltButton_Pressed", IconSkin.Pro);
