...
namespace UnityEditor.ProBuilder.Actions
{
    sealed class SubdivideFaces : MenuAction
    {
        ...
        public override Texture2D icon { get { return IconUtility.GetIcon("Toolbar/Face_Subdivide"); } }
        public override Texture2D icon2x { get { return IconUtility.GetLargeIcon("Toolbar/Face_Subdivide"); } }
