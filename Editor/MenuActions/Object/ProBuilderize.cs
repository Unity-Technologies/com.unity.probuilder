    ...
    sealed class ProBuilderize : MenuAction
    {
            ...
            MeshSelection.objectSelectionChanged += () =>
                {
                    ...
                    // New version : compare number of MeshFilters to number of ProBuilderMeshes to handle PBMesh in deep search
            ...
            MeshImportSettings settings)
        {
            ...
            EditorApplication.delayCall += () =>
            {
                ...
                {
                    // Check if the current object is already a ProBuilder Mesh in case
                    // a PB Mesh is present in the hierarchy to probuilderize
