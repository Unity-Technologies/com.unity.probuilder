...
namespace UnityEngine.ProBuilder.MeshOperations
{
	...
	public static class Normals
	{
		...
		{
			List<EdgeLookup> sourceEdges = EdgeLookup.GetEdgeLookup(source.edges, lookup).ToList();
			List<EdgeLookup> targetEdges = EdgeLookup.GetEdgeLookup(target.edges, lookup).ToList();
