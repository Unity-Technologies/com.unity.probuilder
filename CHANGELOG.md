...
- Handles Prefab encapsulation with Probuilder Meshes
...
- Fixes prefab instance containing an overridden ProBuilderMesh breaks when modifying the original prefab
