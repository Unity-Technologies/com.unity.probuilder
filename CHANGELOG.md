...
## [4.2.4-preview.0] - 2020-02-15

## Bug Fixes

- Fix Shape Builder window not registering settings for "Reset" in the preferences window.

## [4.2.3] - 2020-01-16

## Changes

- Remove unstable lightmapping tests.
- Reorganize unit tests for better usability.
