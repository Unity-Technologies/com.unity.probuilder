...
echo Build 5.0
	mono pb-build.exe build/targets/ProBuilderAdvanced-5.0.json
echo Build 5.3
	mono pb-build.exe build/targets/ProBuilderAdvanced-5.3.json
echo Build 5.5
	mono pb-build.exe build/targets/ProBuilderAdvanced-5.5.json
echo Build 5.6
