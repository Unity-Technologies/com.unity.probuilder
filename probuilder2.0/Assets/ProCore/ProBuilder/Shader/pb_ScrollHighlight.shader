...
////// Lighting:
////// Emissive:
                float3 emissive = lerp(_Highlight.rgb,_Base.rgb,smoothstep( 0.0, 0.2, distance(frac((_EditorTime*_Speed)),i.uv0.r) ));
