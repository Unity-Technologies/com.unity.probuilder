	...
	public static class pb_Version
	{
		...
		public static pb_VersionInfo Current
		{
			get
			{
				...
				return s_LoadedVersion = new pb_VersionInfo("3.0.2-beta.6", "null");
			}
		}
#else
		public static readonly pb_VersionInfo Current = new pb_VersionInfo("3.0.2-beta.6", "en-US: 04-03-2018");
#endif
	}
}
