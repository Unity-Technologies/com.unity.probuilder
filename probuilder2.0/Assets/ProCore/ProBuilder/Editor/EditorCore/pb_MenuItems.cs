...
namespace ProBuilder.EditorCore
{
	static class pb_MenuItems
	{
		...
		private static pb_Editor editor
		{
		...
		{
			pb_MenuCommands.MenuExtrude(selection, false);
		}
		...
		{
			pb_VertexColorPalette.SetFaceColors(1);
		}
		...
		{
			pb_VertexColorPalette.SetFaceColors(2);
		}
		...
		{
			pb_VertexColorPalette.SetFaceColors(3);
		}
		...
		{
			pb_VertexColorPalette.SetFaceColors(4);
		}
		...
		{
			pb_VertexColorPalette.SetFaceColors(5);
		}
		...
		{
			pb_VertexColorPalette.SetFaceColors(6);
		}
		...
		{
			pb_VertexColorPalette.SetFaceColors(7);
		}
		...
		{
			pb_VertexColorPalette.SetFaceColors(8);
		}
		...
		{
			pb_VertexColorPalette.SetFaceColors(9);
		}
		...
		{
			pb_VertexColorPalette.SetFaceColors(0);
		}
	}
}