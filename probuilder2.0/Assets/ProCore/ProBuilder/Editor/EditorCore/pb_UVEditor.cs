...
#region Fields
	...
	public static pb_UVEditor instance;
...
#region Menu
	...
	public static void MenuOpenUVEditor()
	{
		...
		EditorWindow.GetWindow<pb_UVEditor>(pb_PreferencesInternal.GetBool(pb_Constant.pbUVEditorFloating), "UV Editor", true);
	}
...
#else
		pb_UVRenderOptions renderOptions = (pb_UVRenderOptions)ScriptableObject.CreateInstance(typeof(pb_UVRenderOptions));
		renderOptions.screenFunc = InitiateScreenshot;
	...
	static void ContextMenu_OpenFloatingWindow()
	{
		...
		EditorWindow.GetWindow<pb_UVEditor>().Close();
		EditorWindow.GetWindow<pb_UVEditor>(true, "UV Editor", true);
	}
	...
	static void ContextMenu_OpenDockableWindow()
	{
		...
		EditorWindow.GetWindow<pb_UVEditor>().Close();
		EditorWindow.GetWindow<pb_UVEditor>(false, "UV Editor", true);
	}
#endregion
