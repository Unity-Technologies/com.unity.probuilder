...
{
	public class ToggleSelectHidden : pb_MenuAction
	{
		bool isEnabled { get { return pb_Preferences_Internal.GetBool(pb_Constant.pbSelectHidden); } }
...
@"Setting Hidden Element Selection to <b>On</b> allows you to select faces that obscured by geometry.
...
");
		...
		{
			bool isEnabled = pb_Preferences_Internal.GetBool(pb_Constant.pbSelectHidden);
