...
namespace ProBuilder2.UpgradeKit
{
	...
	public class pb_BatchUpdater : EditorWindow
	{
		 ...
		 */
		[MenuItem("Tools/" + pb_Constant.PRODUCT_NAME + "/Upgrade/Batch Prepare Scenes for Upgrade", false, 20)]
		...
		[MenuItem("Tools/" + pb_Constant.PRODUCT_NAME + "/Upgrade/Batch Re-Attach ProBuilder Scripts", false, 21)]
