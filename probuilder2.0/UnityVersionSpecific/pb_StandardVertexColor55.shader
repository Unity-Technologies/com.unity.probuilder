...
/////// GI Data:
				...
				ugls_en_data.boxMax[0] = unity_SpecCube0_BoxMax;
				ugls_en_data.boxMin[0] = unity_SpecCube0_BoxMin;
				ugls_en_data.probePosition[0] = unity_SpecCube0_ProbePosition;
				ugls_en_data.boxMax[1] = unity_SpecCube1_BoxMax;
				ugls_en_data.boxMin[1] = unity_SpecCube1_BoxMin;
				ugls_en_data.probePosition[1] = unity_SpecCube1_ProbePosition;
				ugls_en_data.perceptualRoughness = RoughnessToPerceptualRoughness( 1.0 - gloss );
