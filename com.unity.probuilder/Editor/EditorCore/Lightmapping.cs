...
namespace UnityEditor.ProBuilder
{
	...
	static class Lightmapping
	{
		...
		static void OnLightmappingCompleted()
		{
			...
			var missingUv2 = Object.FindObjectsOfType<ProBuilderMesh>().Where(x => !x.HasArray(MeshArrays.Lightmap) && x.gameObject.HasStaticFlag(StaticEditorFlags.LightmapStatic));
